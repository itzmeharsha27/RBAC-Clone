  ...
  return (
    ...
    >
      <div className="flex justify-between items-center mb-6">
        <h2 className="text-xl font-semibold text-gray-100">Teachers</h2>
        ...
        <table className="min-w-full divide-y divide-gray-700">
          <thead>
            <tr>
              ...
              {role=="HOD" &&(<th className="px-6 py-3 text-left text-xs font-medium text-gray-400 uppercase tracking-wider">Action</th>)}
            </tr>
          </thead>
